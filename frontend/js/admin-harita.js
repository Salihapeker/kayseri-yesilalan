...
export function tesisleriYukle(API) {
  if (tesisGosterimKatmani) map.removeLayer(tesisGosterimKatmani);
  const tesisKumesi = L.markerClusterGroup();
  tesisGosterimKatmani = tesisKumesi;
  ...
  }).catch(() => console.warn('Tesisler yüklenemedi'));
}
