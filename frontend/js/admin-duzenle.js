...
export async function parkSec(id) {
  ...
  document.getElementById("ozellik-bakim-durumu").value = ek.bakim_durumu || "acik";
  document.getElementById("ozellik-son-guncelleme").value = ek.son_guncelleme || "";
  document.getElementById("ozellik-kisa-aciklama").value = ek.kisa_aciklama || "";
  document.getElementById("ozellik-etiketler").value = Array.isArray(ek.etiketler) ? ek.etiketler.join(", ") : "";
  ...
  .addEventListener("click", async () => {
    ...
    const ozellikler = {
      ...
      otopark_kapasitesi: document.getElementById("ozellik-otopark-kapasite")
        ...
        : null,
      bakim_durumu: document.getElementById("ozellik-bakim-durumu").value,
      son_guncelleme: document.getElementById("ozellik-son-guncelleme").value.trim(),
      kisa_aciklama: document.getElementById("ozellik-kisa-aciklama").value.trim(),
      etiketler: document.getElementById("ozellik-etiketler").value.split(",").map((etiket) => etiket.trim()).filter(Boolean),
    };
