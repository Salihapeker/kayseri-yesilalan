...
export function sonEklenenleriYukle() {
  fetch(`${API}/son-eklenenler`).then(r => {
    ...
    document.getElementById('son-eklenenler-liste').innerHTML = '<p class="hint">Kayıtlar yüklenemedi. API bağlantısını kontrol edin.</p>';
  });
}
