...
document.getElementById("yakinim-btn").addEventListener("click", () => {
  ...
  navigator.geolocation.getCurrentPosition(
    async (pos) => {
      ...
      document.getElementById("yakinimdakiler-liste").innerHTML = sonuclar
        .map(
          (s) => `
      <div class="satir">
